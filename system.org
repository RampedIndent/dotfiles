...
#+begin_src shell :tangle ./bin/rofi-power-menu :shebang "#!/bin/bash"
  ...
  actions[displayoff]="~/.dotfiles/bin/rofi-power-menu-sleep"
...
** Autostart
#+begin_src shell :tangle ~/.config/leftwm/autostart.sh :shebang "#!/bin/bash"
...
*** Custom Theme
**** Up
#+begin_src shell :tangle:tangle ~/.config/leftwm/themes/custom-theme/up :shebang "#!/bin/bash"
...
#+begin_src shell :tangle:tangle ~/.config/leftwm/themes/custom-theme/down :shebang "#!/bin/bash"
    pkill picom
    pkill polybar
