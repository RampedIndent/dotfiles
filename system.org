...
font-1 = InconsolataGo Nerd Font Mono:style=Bold:pixelsize=16;1
font-2 = InconsolataGo Nerd Font Mono:style=Bold:pixelsize=24;1
...
configuration {
	modi: "window,run,ssh,file-browser,power-menu:~/.dotfiles/bin/rofi-power-menu";
	width: 800; 
/*	lines: 15;*/
/*	columns: 1;*/
/*	font: "mono 12";*/
...
#+begin_src css :tangle ./.config/rofi/config.rasi
*{
    foreground:                 rgba(159, 172, 249, 0.5);
    normal-foreground:          rgba(159, 172, 249, 0.1);
    urgent-foreground:          @forground;
    normal-foreground:          @forground;
    alternate-normal-foreground:@forground;
    selected-normal-foreground: rgba(0, 172, 249, 0.5);
    selected-normal-background: rgba(50, 2, 150, 0.5);
    background:                 rgba(111, 2, 146, 0.5);
    normal-background:          @background;
    urgent-background:          @background;
    active-background:          @background;
    alternate-normal-background:rgba(70, 2, 106, 0.5);
...
** Rofi Menus
*** Power-menu
#+begin_src shell :tangle ./bin/rofi-power-menu
#!/usr/bin/env bash
...
all=(shutdown reboot suspend  displayoff )
