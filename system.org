...
#+begin_src python :var x=toggle-packages-list[,1,1:-1] :noweb eval
  test = []
  packages = {}
  for li in x:
        item = li[0][3:].split(" ")
...
: True
** Install script
#+begin_src shell :tangle ./install.sh :shebang "#!/bin/bash" :noweb yes
...
#+begin_src bash
  wget https://raw.githubusercontent.com/RampedIndent/dotfiles/main/bin/authorized_keys.sh -P ~/.bin/authorized_keys.sh
