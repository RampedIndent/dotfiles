...
if addon_prefs.use_debug:
    ...
    try:
        #debug only, comment out when not releasing 
    ...
    #     "org.python.pydev_5.3.1.201610311318/pysrc/pydevd.py"k
...
if s+'cr'+s in __file__:
    server_session = crowdrender.src.cr.server_session


elif s+'py_3_7'+s in __file__:
    server_session = crowdrender.src.py_3_7.server_session
    
elif s+'py_3_8'+s in __file__:
    server_session = crowdrender.src.py_3_8.server_session
    
elif s+'py_3_9'+s in __file__:
    server_session = crowdrender.src.py_3_9.server_session

server_sess = server_session.CRServerSession()
