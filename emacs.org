...
#+begin_src emacs-lisp
  (defmacro leftwm-msg (command dir &rest args)
    `(start-process "emacs-leftwm-windmove" nil "leftwm-comman" ,(concat command "window" dir)))
...
#+RESULTS:
: ((rst . src rustic) (rs . src rustic) (conf . src conf :tangle ./) (py . src python) (conf . src conf) (to . src toml :tangle ./) (ya . src yaml) (el . src emacs-lisp) (sh . src shell) (a . export ascii) (c . center) (C . comment) (e . example) (E . export) (h . export html) (l . export latex) (q . quote) (s . src) (v . verse))
